...
var HeatBox = function (_a) {
    ...
    if (!blank) {
        if (opacity === 0) {
            return (React.createElement("div", { "data-tip": tooltip, style: { backgroundColor: "lightgrey" }, className: "heatmap-box" + (" opacity-" + opacity + " ") + className, onClick: function () { return onSelect && onSelect(); } }, label));
        }
        return (React.createElement("div", { "data-tip": tooltip, style: { backgroundColor: highlightColor }, className: "heatmap-box" + (" opacity-" + opacity + " ") + className, onClick: function () { return onSelect && onSelect(); } }, label));
    }
...
var Month = /** @class */ (function (_super) {
    ...
    Month.prototype.render = function () {
        ...
        Object.keys(this.props.data).forEach(function (x) {
            var opacity = parseInt(_this.props.data[x].relativePercent.toFixed(0));
            if (_this.props.enableStep === true) {
                opacity = StepFunction(opacity, _this.props.stepSize || 20);
            }
            days.push(HeatBox({
    ...
    RenderHeatMap.prototype.render = function () {
        ...
        Object.keys(this.props.data).forEach(function (year) {
            Object.keys(_this.props.data[year]).forEach(function (month) {
                data.push(React.createElement(Month, { data: _this.props.data[year][month], month: parseInt(month), year: parseInt(year), highlightColor: _this.props.highlightColor, valueLabel: _this.props.valueLabel, onSelect: _this.props.onSelect, stepSize: _this.props.stepSize, enableStep: _this.props.enableStep }));
            });
        });
        return data;
    };
...
var HeatMap = /** @class */ (function (_super) {
    ...
    HeatMap.prototype.render = function () {
        ...
        var parsedData = data.reduce(function (acc, cur) {
            ...
            var curr = acc["" + year]["" + month]["" + day].value;
            if (curr > max)
                max = curr;
            return acc;
        }, {});
        ...
        return (React.createElement("div", { className: "heatmap" },
            ...
            React.createElement(RenderHeatMap, { onSelect: this.props.onSelect, valueLabel: this.props.valueLabel, highlightColor: highlightColor, data: filledData, stepSize: this.props.stepSize, enableStep: this.props.enableStep })));
    };
    return HeatMap;
}(React.Component));
export { HeatMap };
