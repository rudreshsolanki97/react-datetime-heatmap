    ...
    RenderHeatMap.prototype.render = function () {
        ...
        Object.keys(this.props.data).forEach(function (year) {
            Object.keys(_this.props.data[year]).forEach(function (month) {
                data.push(React.createElement(Month, { data: _this.props.data[year][month], month: parseInt(month), year: parseInt(year), highlightColor: _this.props.highlightColor, valueLabel: _this.props.valueLabel, onSelect: _this.props.onSelect }));
            });
        });
        return data;
    };
...
var HeatMap = /** @class */ (function (_super) {
    ...
    HeatMap.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "heatmap" },
            ...
            React.createElement(RenderHeatMap, { onSelect: this.props.onSelect, valueLabel: this.props.valueLabel, highlightColor: highlightColor, data: filledData })));
    };
    return HeatMap;
}(React.Component));
export { HeatMap };
