    ...
    RenderHeatMap.prototype.render = function () {
        ...
        Object.keys(this.props.data).forEach(function (year) {
            Object.keys(_this.props.data[year]).forEach(function (month) {
                data.push(react_1.default.createElement(Month, { data: _this.props.data[year][month], month: parseInt(month), year: parseInt(year), highlightColor: _this.props.highlightColor, valueLabel: _this.props.valueLabel, onSelect: _this.props.onSelect, stepSize: _this.props.stepSize, enableStep: _this.props.enableStep }));
            });
        });
        return data;
    };
...
var HeatMap = /** @class */ (function (_super) {
    ...
    HeatMap.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: "heatmap" },
            ...
            react_1.default.createElement(RenderHeatMap, { onSelect: this.props.onSelect, valueLabel: this.props.valueLabel, highlightColor: highlightColor, data: filledData, stepSize: this.props.stepSize, enableStep: this.props.enableStep })));
    };
    return HeatMap;
}(react_1.default.Component));
